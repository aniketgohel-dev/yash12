$(function () {
    ...
    /*$(window).scroll(function() {
       ...
       /*else if($(nav).hasclass("navbar-fixed")){
...
function navmenu() {
    ...
    navbar1.classList.remove("nodisplay");
    var navbar = document.getElementById("navbar-content");
    var navbtn = document.getElementById("navbtn");
    if(navbar.classList.contains("head1")) {
        navbar.classList.replace("head1", "head1-show");
        navbar.classList.add("navbar-collapse");


    }
    else{
        /*navbar.classList.replace( "head1-show","head1");
        navbar1.classList.toggle("navbar-collapse");*/
    }
}
function closenav() {
    var navbar = document.getElementById("navbar");
   var navbar1 = document.getElementById("navbar-content");

    /*navbar1.classList.remove("navbar-collapse");
    navbar1.classList.remove("head1-show");
    navbar.classList.remove("navbar","navbar-fixed");*/
